...
img.onclick = function(){
    ...
    captionText.innerHTML = "<br>"+"Last night was peaceful."
    +"<br>"+"But this morning both Amy and Tommy began to claim themseleves as the guard."
    +"<br>"+"It reminds me that Sumner told me he has invited a guard and a detective."+
    "<br>"+"So who are playing these two roles in this family?";
}
