...
img.onclick = function(){
    ...
    captionText.innerHTML = "<br>"+"Later I got to know Sophie is Sumner's sister, and Tommy is her lover."
    +"<br>"+
    "The rest of them, except for Harry, are all distant relatives of Sumner."+"<br>"+
    "But Sophie and Ethan were found to be dead this morning...";
}
