...
img.onclick = function(){
    ...
    modalImg.src = "images/relation/relation3.png";
    captionText.innerHTML = "Maybe because I have nothing to do with the familiy wealth, no one seems to suspect me."+
    "<br>"+"Somehow all people began to focus on Harry and Carl.";
}
...
voteimg.onclick = function(){
    ...
    votecaptionText.innerHTML = "Those people agreed on voting for another person to be sent to the police today."+"<br>"+"Who should I vote for?"
}

function conti(){
    if (option == 1){
        window.location.href='day2-3-2.html';
    }else{
    window.location.href='day2-3-1.html';
}
}
...
function result1(){
    ...
    votecaptionText.innerHTML = "In the end, we decided to sent Carl to the police as he seemed most likely to be the criminal."
}
