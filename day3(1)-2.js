...
img.onclick = function(){
    ...
    modalImg.src = "images/relation/relation4.png";
    captionText.innerHTML = "<br>"+"Now I kinda understand why there were two persons died during the second night."
    ;
}
...
voteimg.onclick = function(){
    ...
    votecaptionText.innerHTML = "People agreed on voting for another person to be sent to the police."+"<br>"+"Who should I vote for?"
}
...
function conti(){
    ...
    window.location.href='win.html';}
        ...
        window.location.href='day3(1)-3.html';
    }
}
...
function result1(){
    ...
    votecaptionText.innerHTML = "In the end, we decided to sent Amy to the police as she seemed most likely to be the criminal."
}
